...
const Home: NextPageWithLayout = () => {
  ...
  return (
    <>
      ...
      <main className="container mx-auto mt-32 mb-14 flex max-w-2xl flex-col gap-8 px-4">
        <a
        ...
        >
          ...
          <button
            ...
            className="w-full rounded-md bg-gray-400 px-4 py-2 text-base font-medium transition-colors enabled:hover:bg-gray-500 enabled:active:bg-gray-400"
            disabled={isLoading}
          >
