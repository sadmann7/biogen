...
const Home: NextPageWithLayout = () => {
    ...
    const prompt =
      data.vibe === VIBE.PROFESSIONAL
        ...
        ? `Generate 2 aesthetic ${
            data.platform
          } bios with no hashtags and clearly labeled "1." and "2.". Make sure each generated bio is at least 14 words and at max 20 words. Also make sure to use some uncommon aesthetic words and emojis and base them on this context: ${
            data.bio
          }${data.bio.slice(-1) === "." ? "" : "."}`
        : `Generate 2 funny ${
            data.platform
  ...
  return (
    <>
      ...
      <main className="container mx-auto mt-32 mb-14 grid min-h-screen max-w-2xl gap-10 px-4">
        <a
