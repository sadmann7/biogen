      ...
      <nav className="container mx-auto flex max-w-screen-lg items-center justify-between border-b-2 border-b-gray-500 px-4 py-5">
        ...
        {status === "authenticated" ? (
          ...
          <Link
            ...
            className="rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-gray-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 active:bg-gray-100"
          >
            Sign in
          </Link>
        )}
